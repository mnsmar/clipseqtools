...
package CLIPSeqTools::App::Command::count_reads_on_genic_elements;
...
with 
	...
	"CLIPSeqTools::Role::GeneCollectionInput" => {
...
#######################################################################
sub description {
	'Read counts on genic elements (ie. transcripts, genes, exons, introns)';
}
