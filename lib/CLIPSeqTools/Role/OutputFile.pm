...
package CLIPSeqTools::Role::OutputFile;
...
has 'o_file' => (
	...
	isa           => 'Str',
	traits        => ['Getopt'],
	documentation => 'filename for output file. If path does not exist it will be created.',
);
...
sub validate_args {
	...
	$self->usage_error('Output file is required') if !$self->o_file;
}
